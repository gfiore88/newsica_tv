...
if [ "$STREAM_TEST_CARD" = "1" ]; then
  ...
  FILTER='[0:v]scale=1280:720:force_original_aspect_ratio=decrease,pad=1280:720:(ow-iw)/2:(oh-ih)/2:color=0x0a1128,setsar=1,format=yuv420p,fps=30[bg]; [bg]drawbox=y=ih-80:color=black@0.7:width=iw:height=80:t=fill[bg_box]; [bg_box]drawtext=textfile='"$TICKER_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=white:fontsize=40:y=h-60:x=w-mod(t*200\,w+tw):alpha=0.9[ticker]; [ticker]drawbox=x=0:y=ih-80:color=red@1:width=250:height=80:t=fill[ticker_box]; [ticker_box]drawtext=text='"'"'ULTIMORA'"'"':fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=white:fontsize=35:x=20:y=h-58[main_v]; [main_v]drawbox=x=30:y=30:w=470:h=92:color=0x0f172ad1:t=fill[top_bg]; [top_bg]drawtext=textfile='"$ACCENT_NEWS_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=0xef4444:fontsize=1:x=30:y=30:box=1:boxcolor=0xef4444:boxw=8:boxh=92:alpha=gt(tw\,0)[accent_news]; [accent_news]drawtext=textfile='"$ACCENT_SPORT_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=0x22c55e:fontsize=1:x=30:y=30:box=1:boxcolor=0x22c55e:boxw=8:boxh=92:alpha=gt(tw\,0)[accent_sport]; [accent_sport]drawtext=textfile='"$ACCENT_METEO_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=0x38bdf8:fontsize=1:x=30:y=30:box=1:boxcolor=0x38bdf8:boxw=8:boxh=92:alpha=gt(tw\,0)[accent_meteo]; [accent_meteo]drawtext=textfile='"$ACCENT_WELLNESS_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=0x14b8a6:fontsize=1:x=30:y=30:box=1:boxcolor=0x14b8a6:boxw=8:boxh=92:alpha=gt(tw\,0)[accent_wellness]; [accent_wellness]drawtext=textfile='"$ACCENT_MUSIC_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=0x8b5cf6:fontsize=1:x=30:y=30:box=1:boxcolor=0x8b5cf6:boxw=8:boxh=92:alpha=gt(tw\,0)[accent_music]; [accent_music]drawtext=textfile='"$ACCENT_BREAKING_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=0xdc2626:fontsize=1:x=30:y=30:box=1:boxcolor=0xdc2626:boxw=8:boxh=92:alpha=gt(tw\,0)[top_accent]; [top_accent]drawtext=text='"'"'ON AIR'"'"':fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=0xfca5a5:fontsize=14:x=52:y=42[top_label]; [top_label]drawtext=textfile='"$PROGRAM_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=white:fontsize=24:x=52:y=60:expansion=none[current_program]; [current_program]drawtext=textfile='"$NEXT_PROGRAM_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=0xcbd5e1:fontsize=16:x=52:y=94:expansion=none[main_osd]; [main_osd]drawbox=x=w-200:y=30:w=170:h=92:color=0x0f172ad1:t=fill[clock_bg]; [clock_bg]drawbox=x=w-38:y=30:w=8:h=92:color=0xffffff99:t=fill[clock_accent]; [clock_accent]drawtext=textfile='"$CLOCK_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=white:fontsize=32:x=w-182:y=44[clock_time]; [clock_time]drawtext=textfile='"$DATE_FILE"':reload=1:fontfile=/System/Library/Fonts/Helvetica.ttc:fontcolor=0xcbd5e1:fontsize=14:x=w-182:y=84[outv]'
fi
