...
- [ ] **Estensione copertura test regressivi:** I test sono obbligatori su ogni patch; resta aperto il cantiere per ampliare sistematicamente la copertura dei rami critici della regia live (`director.py`, breaking news, restore slot, control bus, scheduler, playout state) fino a rendere i bug di regressione eccezioni rare e subito intercettate.
